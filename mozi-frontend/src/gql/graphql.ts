...
export type GetReviewsQuery = { __typename?: 'Query', getReviewsOfUser: Array<{ __typename?: 'ReviewListReview', id: string, rating: string, description: string, movie: { __typename?: 'ReviewMovie', id: string }, user: { __typename?: 'ReviewUser', id: string, first_name: string, last_name: string } }>, getNumberOfReviewsOfUser: { __typename?: 'numOfReviews', totalCount?: number | null } };
