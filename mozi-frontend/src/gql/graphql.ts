...
export type CreateReviewMutation = { __typename?: 'Mutation', createReview?: { __typename?: 'DbReview', id: string, rating: string, description: string, movie_id: string, user_id: string } | null };
